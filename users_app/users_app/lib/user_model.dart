class User {
  ...
  User.fromJson(Map<String, dynamic> json) {
    ...
    employment = json['employment'] != null ? new Employment.fromJson(json['employment']) : null;
    address = json['address'] != null ? new Address.fromJson(json['address']) : null;
    creditCard = json['credit_card'] != null ? new CreditCard.fromJson(json['credit_card']) : null;
...
class Address {
  ...
  Address({this.city, this.streetName, this.streetAddress, this.zipCode, this.state, this.country, this.coordinates});
